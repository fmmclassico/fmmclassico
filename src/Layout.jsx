...
import HeaderSearchBar from '@/components/search/HeaderSearchBar.jsx';
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          <HeaderSearchBar
            ...
            className="flex flex-1 max-w-xl mx-2 md:mx-6"
      ...
      <div className="w-full px-4 md:px-8 xl:px-[2cm]">
        <div className="flex items-center justify-between h-16">
          ...
          <HeaderSearchBar
            ...
            className="hidden md:flex flex-1 max-w-xl mx-4 lg:mx-6 xl:mx-8"
