      ...
      {currentPageName === 'ProductDetail' && (
        <>
          <a
            ...
            className="fixed bottom-24 md:bottom-8 right-1 z-40 flex items-center gap-1 bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded-full shadow-xl transition-all hover:scale-105 active:scale-95 opacity-80 hover:opacity-100"
