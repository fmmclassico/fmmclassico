...
export default function Home() {
  ...
  const categories = ['phone_cases', 'chargers', 'earphones', 'cables', 'power_banks', 'screen_protectors', 'holders', 'speakers'];
  ...
  return (
    <div className="pb-6">
      ...
      <section className="relative bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-400 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?w=1200')] bg-cover bg-center opacity-10" />
        <div className="container mx-auto px-4 py-12 md:py-20 relative">
          ...
          >
            ...
            <p className="text-lg text-white/90 mb-6">
              Discover the latest phone cases, chargers, earphones and gadgets at unbeatable prices.
            </p>
