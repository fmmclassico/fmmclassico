...
export default function Login() {
  ...
  // Get the return URL saved before redirect
  const getReturnUrl = () => {
    const saved = sessionStorage.getItem('redirectAfterLogin');
    return saved && saved !== '/login' && saved !== '/register' ? saved : '/';
  };
  ...
  // Social login handlers — all redirect back to where the user came from
  const handleGoogle = () => {
    const returnUrl = getReturnUrl();
    sessionStorage.removeItem('redirectAfterLogin');
  ...
  return (
    <AuthLayout
      icon={LogIn}
      title="Welcome back"
      subtitle="Log in to your FMM CLASSICO account"
      footer={
        <>
