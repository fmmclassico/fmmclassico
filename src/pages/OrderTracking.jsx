...
import { getPaymentStatusLabel, isBalancePaymentEnabled as isHubtelBalancePaymentEnabled, isInitialPaymentConfirmed, isRemainingBalancePaid as isHubtelRemainingBalancePaid } from '@/api/hubtelClient';
...
function isBalanceEnabled(order) { return isHubtelBalancePaymentEnabled(order); }
...
export default function OrderTracking() {
  ...
  const initialPaid = isInitialPaymentConfirmed(order);
